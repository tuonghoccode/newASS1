...
void validSubmittedFiles(string filename, string *allowedIncludingFiles,
                         int numOfAllowedIncludingFiles = 1) {
...
int main(int argc, char **argv) {
  ...
  // test(argv[1]);
  test("/Users/Tam Thanh Tin/Desktop/newASS1/assignment1/testcase/test1.txt");
